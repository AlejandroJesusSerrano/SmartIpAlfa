...
class Movments(models.Model):
    ...
    tech = models.ForeignKey(Techs, on_delete=models.CASCADE, related_name='movments_techs')
    mov_type = models.ForeignKey(MovType, on_delete=models.CASCADE, related_name='movments_mov_type')
...
class Dependencies(models.Model):
    adress = models.ForeignKey(Address, on_delete=models.CASCADE, related_name='dependency_address')
...
class Office(models.Model):
    dependencies = models.ForeignKey(Dependencies, on_delete=models.CASCADE, related_name='office_dependency')
...
class Devices(models.Model):
    ...
    user_i_access = models.ForeignKey(Ip, on_delete=models.CASCADE, related_name='devices_i_access')
